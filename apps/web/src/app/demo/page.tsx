...
export default function DemoPage() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ marginTop: 0, color: "#93c5fd" }}>
          Trustify Demo Integration
        </h1>
        <p style={{ marginTop: 0, color: "#cbd5e1" }}>
          Minimal vertical slice: File → IPFS → registerDocument →
          verifyDocument
        </p>
        <input
          type="file"
        ...
        <div style={{ color: "#bfdbfe", wordBreak: "break-all" }}>
          Hash: {hash || "-"}
        </div>
        ...
        <div
          style={{ marginTop: 12, color: "#86efac", wordBreak: "break-all" }}
        >
          Tx: {txHash || "-"}
        </div>
