...
import { IssuerGuard } from "../../../components/guards/issuer-guard";
...
import { IssuerSidebar } from "@/components/layout/issuer-sidebar";
      ...
      <WalletGuard>
        <NetworkGuard>
          <div className="min-h-screen bg-linear-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
            ...
            {mobileOpen && <IssuerSidebar mobile onClose={() => setMobileOpen(false)} />}
